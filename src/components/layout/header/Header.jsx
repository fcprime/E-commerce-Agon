          ...
          <div className="header__top">
            ...
            <nav className="menu">
              ...
              <div className="menu__search">
                ...
                <input className="menu__search-input" type="text" placeholder="Search" />
              </div>
              <Link to="/favorite" className="menu__favorite">
                <svg
                  width="24"
                  height="21"
                  viewBox="0 0 24 21"
              ...
              <Link to="/cart" className="menu__cart">
                <div className="menu__cart-qty">0</div>
                <svg
                  width="20"
                  height="22"
                  viewBox="0 0 20 22"
            ...
            <div className="menu__register">
              ...
              <Link className="menu__link menu__login" to="/login">
                Login
              </Link>
              <span className="menu__link-span"> or </span>
              <Link className="menu__link menu__signup" to="/register">
                Sign Up
              </Link>
            </div>
          </div>
