      ...
      <div className="product">
        <a
          ...
          <div className="product__item-box">
            ...
            <div className="product__item-price">$129.80</div>
          </div>
        </a>
        <a
          className="product__item"
          ...
          <div className="product__item-box">
            ...
            <div className="product__item-price">$79.00</div>
          </div>
        </a>
        <a
          className="product__item"
          ...
          <div className="product__item-img">
            <img
              className="product__item-images"
              src={headphonePink}
              alt="monitor image"
            />
          </div>
          <div className="product__item-box">
            <h3 className="product__item-title">
              T500BT Original Wireless Bluetooth Headphone Deep
            </h3>
