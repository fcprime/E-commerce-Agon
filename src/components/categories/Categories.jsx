  ...
  <section className="categories">
    <div className="container">
      ...
      <div className="categories__subtitle">
        We provide many categories, choose a category according to your expertise to make it easier
        to find a job.
      </div>
      <div className="categories__wrapper">
        <div className="categories__aside">
          ...
          <div className="categories__items">
            <ul className="categories__list">
              <a href="#" className="categories__list-link">
        ...
        <div className="categories__inner">
          <a className="categories__box-link" href="#">
            <div className="categories__box-img">
              <img src={designIcon} alt="categories computer image" />
            </div>
            <p className="categories__box-text">Computer for Designer, Art</p>
          </a>
          <a className="categories__box-link" href="#">
            <div className="categories__box-img">
              <img src={laptopIcon} alt="categories computer image" />
            </div>
          ...
          <a className="categories__box-link" href="#">
            <div className="categories__box-img">
              <img src={bookIcon} alt="categories computer image" />
            </div>
            <p className="categories__box-text">Software, card, book</p>
          </a>
          <a className="categories__more-link" href="#">
            <div className="categories__more-img">
              <img src={exploreMoreIcon} alt="categories computer image" />
            </div>
      ...
      <a className="categories__link" href="#">
        <div className="categories__link-work">How It Work?</div>
      </a>
    </div>
  </section>;
};
